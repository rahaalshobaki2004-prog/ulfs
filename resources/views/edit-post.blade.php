    ...
    <section class="container mx-auto px-6 py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                <form action="{{ route('my-posts.update', $post)  }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <label class="cursor-pointer">
                                <input type="radio" name="type" value="lost" class="hidden peer" {{ old('type', $post->type) == 'lost' ? 'checked' : '' }} required>
                            ...
                            <label class="cursor-pointer">
                                <input type="radio" name="type" value="found" class="hidden peer" {{ old('type', $post->type) == 'found' ? 'checked' : '' }} required>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea id="description" name="description" rows="6" required
                                  ...
                                  placeholder="Where did you lose/find it? Any special marks? Color? Contents?">{{ old('description', $post->description) }}</textarea>
                        @error('description')
                            <p class="text-red-600 text-sm mt-2">{{ $message }}</p>
                        @enderror
                    </div>
